...
class Webinar extends CI_Controller {
    ...
    {   
        ...
        $data['title']       = 'Data Pengunjung Webinar';
        $data['description'] = '';
        $data['keywords']    = '';
        $data['page']           = 'admin/report/webinar';
    ...
    function _sql($group_by) 
    {
        ...
        $this->db->select('
            ...
            SUM(a.hits) as total
        ');
        $this->db->from('tb_analytic_webinar a USE INDEX (webinar_report)');  
        $this->db->join('tb_webinar b', 'a.id_webinar = b.id_webinar', 'left');   
    ...
    {   
        ...
        $this->main_model->datatable_custom($valid_columns, ' a.id_webinar ', ' total DESC ');
        ...
        foreach($query->result_array() as $key) {
            ...
            $url_detail  = 'https://www.youtube.com/watch?v='.$key['kode_youtube'];
        ...
        $response['recordsTotal']      = $this->_sql(' a.id_webinar ')->num_rows();
        $response['recordsFiltered']   = $this->_sql(' a.id_webinar ')->num_rows();
        ...
        if ($cact['access_view'] == 'd-none') {
            ...
            if ($value == 'last7') {
                ...
                foreach ($array_date as $key) {
                    ...
                    $get = $this->db->query("
                        SELECT SUM(a.hits) as total 
                        FROM tb_analytic_webinar a USE INDEX (webinar_report)
