...
class Testimoni extends CI_Controller {
    ...
    public function Index()
    {
        ...
        $data['description'] = '';
        $data['keywords']    = '';
        $data['page']           = 'admin/content/home/testimoni';
    ...
    function _sql() 
    {
        ...
        $this->db->where('c.section', 'home_testimoni');
    ...
    {   
        ...
        foreach($query->result_array() as $key) {
            ...
            $data[] = array(
                ...
                character_limiter(strip_tags($key['content']), 25),
    ...
    {   
        ...
        if ($cact['access_add'] == 'd-none') {
            ...
            $subheading       = sanitize_input($this->input->post('subheading'));
    ...
    {   
        ...
        if ($cact['access_edit'] == 'd-none') {
            ...
            $this->form_validation->set_rules('heading', 'heading', 'trim|required');
            $this->form_validation->set_rules('subheading', 'subheading', 'trim|required');
            $this->form_validation->set_rules('id', 'id', 'trim|required|callback_valid_huruf_angka_spasi');
    ...
    private function upload_image($name)
    {
        ...
        $config['file_name']    = 'Testimoni-'.substr(str_shuffle('ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'), 0, 10);
        $config['quality']      = '60%';
