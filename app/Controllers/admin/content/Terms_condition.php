...
class Terms_condition extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['title']       = 'Data Terms Condition';
        $data['description'] = '';
        $data['keywords']    = '';
        $data['page']           = 'admin/content/terms_condition';
    ...
    {   
        ...
        if ($cact['access_view'] == 'd-none') {
            ...
            $query = $this->db->query("SELECT * FROM tb_content WHERE section = 'terms_condition' ")->row_array();
