        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-start flex-wrap gap-2">
                    ...
                    <div>
                        <p class="mb-1">Total Pengunjung <span id="load_total_transaksi_label"></span></p>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-start flex-wrap gap-2">
                    ...
                    <div>
                        <p class="mb-1">Total URL Referal <span id="load_total_omset_label"></span></p>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table_data = $('#table-data').DataTable({
            ajax: {
                url : '<?php echo base_url();?>admin/report/blog/datatables',
                complete: function(data, type) {
                    json = data.responseJSON;
                    $('#load_total_pengunjung').html(json.total_pengunjung+' <span class="fw-400 fs-6">Pengunjung</span>');
                    $('#load_total_url_referral').html(json.total_referral+' <span class="fw-400 fs-6">URL Referal</span>');
                },
            },
            columnDefs : [
                {
        ...
        $('#form-filter').submit(function(e) {
            ...
            url_reload = '<?php echo base_url();?>admin/report/blog/datatables/?' + filter;
        ...
        load_data_url_referal('');
            
            function load_data_url_referal(filter) {
                $.ajax({
                    url : '<?php echo base_url();?>admin/report/blog/load_data_url_referal?'+filter,
            ...
            function load_total_date(value) {
                $.ajax({
                    method  : 'post',
                    url     : '<?php echo base_url();?>admin/report/blog/fetch_data_total_date',
                    data    : { value:value },
                    dataType: 'json',
                    success: function(response) {
                        if (response.status == 1) {   
