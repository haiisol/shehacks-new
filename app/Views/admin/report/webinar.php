        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-start flex-wrap gap-2">
                    ...
                    <div>
                        <p class="mb-1">Total Unik IP Adrress Pengunjung <span id="load_total_omset_label"></span></p>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table_data = $('#table-data').DataTable({
            ajax: {
                url : '<?php echo base_url();?>admin/report/webinar/datatables',
                complete: function(data, type) {
                    json = data.responseJSON;
                    $('#load_total_pengunjung').html(json.total_pengunjung+' <span class="fw-400 fs-6">Pengunjung</span>');
                    $('#load_total_url_referral').html(json.total_referral+' <span class="fw-400 fs-6">Unik IP Address</span>');
                },
            },
            columnDefs : [
                {
        ...
        $('#form-filter').submit(function(e) {
            ...
            url_reload = '<?php echo base_url();?>admin/report/webinar/datatables/?' + filter;
            ...
            function load_total_date(value) {
                $.ajax({
                    url  : '<?php echo base_url();?>admin/report/webinar/fetch_data_total_date',
                    data : { value:value },
