        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="form-data" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="control-label">Usaha <span class="text-danger">*</span></label>
                        <input type="text" name="subheading" id="subheading" placeholder="" class="form-control">
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table_data = $('#table-data').DataTable({
            ajax: {
                url : '<?php echo base_url();?>admin/content/home/testimoni/datatables',
            },
            columnDefs : [
                {
        ...
        $.validator.addMethod('cek_value', function(value, element) {
            $.ajax({
                method   : 'post',
                url      : '<?php echo base_url();?>admin/content/home/testimoni/cek_value',
                data     : { value:value },
                dataType : 'json',
        ...
        // --------------------------- add & edit data --------------------------- 
            ...
            $(document).on('click', '.edit-data', function() {
                ...
                $.ajax({
                    type     : 'POST',
                    url      : '<?php echo base_url(); ?>admin/content/home/testimoni/get_data',
                    data     : { id:id },
                    dataType : 'json',
                    success: function(response) {
                        $('#id').val(response.id);
            ...
            $('#form-data').submit(function(e) {
                ...
                if (validate_form.valid()) {
                    ...
                    if(save_method == 'add') {
                        url = '<?php echo base_url(); ?>admin/content/home/testimoni/add_data';
                    } else {
                        url = '<?php echo base_url(); ?>admin/content/home/testimoni/edit_data';
                    }
        ...
        // --------------------------- detail data ---------------------------
            $(document).on('click', '.detail-data', function() {
                ...
                $.ajax({
                    type     : 'POST',
                    url      : '<?php echo base_url(); ?>admin/content/home/testimoni/detail_data',
                    data     : { id:id },
                    dataType : 'json',
                    success: function(response) {
        ...
        // --------------------------- change status ---------------------------
            ...
            $(document).on('click', '#submit-change-status', function() {
                ...
                $.ajax({
                    type : 'POST',
                    url  : '<?php echo base_url();?>admin/content/home/testimoni/change_status',
        ...
        // --------------------------- delete data ---------------------------
            ...
            $(document).on('click', '#button-delete', function() {
                ...
                $.ajax({
                    type : 'POST',
                    url  : '<?php echo base_url();?>admin/content/home/testimoni/delete_data',
