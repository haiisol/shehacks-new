            ...
            <div class="modal-body">
                <form method="post" id="form-data" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="control-label">Nama Agenda<span class="text-danger">*</span></label>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table_data = $('#table-data').DataTable({
            ajax: {
                url : '<?php echo base_url();?>admin/content/home/agenda/datatables',
            },
            columnDefs : [
                {
        ...
        $.validator.addMethod('cek_value', function(value, element) {
            $.ajax({
                method   : 'post',
                url      : '<?php echo base_url();?>admin/content/home/agenda/cek_value',
                data     : { value:value },
                dataType : 'json',
        ...
        // --------------------------- add & edit data --------------------------- 
            ...
            $(document).on('click', '.edit-data', function() {
                ...
                $.ajax({
                    type     : 'POST',
                    url      : '<?php echo base_url(); ?>admin/content/home/agenda/get_data',
                    data     : { id:id },
                    dataType : 'json',
                    success: function(response) {
                        $('#id').val(response.id);
            ...
            $('#form-data').submit(function(e) {
                ...
                if (validate_form.valid()) {
                    ...
                    if(save_method == 'add') {
                        url = '<?php echo base_url(); ?>admin/content/home/agenda/add_data';
                    } else {
                        url = '<?php echo base_url(); ?>admin/content/home/agenda/edit_data';
                    }
        ...
        // --------------------------- detail data ---------------------------
            $(document).on('click', '.detail-data', function() {
                ...
                $.ajax({
                    type     : 'POST',
                    url      : '<?php echo base_url(); ?>admin/content/home/agenda/detail_data',
                    data     : { id:id },
                    dataType : 'json',
                    success: function(response) {
        ...
        // --------------------------- change status ---------------------------
            ...
            $(document).on('click', '#submit-change-status', function() {
                ...
                $.ajax({
                    type : 'POST',
                    url  : '<?php echo base_url();?>admin/content/home/agenda/change_status',
        ...
        // --------------------------- delete data ---------------------------
            ...
            $(document).on('click', '#button-delete', function() {
                ...
                $.ajax({
                    type : 'POST',
                    url  : '<?php echo base_url();?>admin/content/home/agenda/delete_data',
