                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail">
                                        <img id="image_preview_2" src="<?php echo default_image(); ?>">
                                    </div>
                                    <div class="fileupload-preview fileupload-exists thumbnail"></div>
                                    <div id="image_feed_2">
                                        <span class="btn btn-outline-primary btn-file">
...
<script>
    ...
    $(document).ready(function() {
        ...
        function load_data() {
            ...
            $.ajax({
                url : '<?php echo base_url();?>admin/content/home/rangkaian_event/get_data',
        ...
        // --------------------------- edit data ---------------------------
            $('#form-data').submit(function(e) {
                ...
                if (validate_form.valid()) {
                    ...
                    $.ajax({
                        method : 'POST',
                        url    : '<?php echo base_url();?>admin/content/home/rangkaian_event/edit_data',
