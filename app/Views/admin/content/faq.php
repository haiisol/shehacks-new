            ...
            <div class="modal-body">
                <form method="post" id="form-data" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="heading" id="heading" placeholder="" class="form-control" style="height: 100px"></textarea>
                    </div>
            ...
            <div class="modal-body">
                <div class="list-info">
                    ...
                    <div class="list-item">
                        ...
                        <p class="value" id="d_description"></p>
                    </div>
                    <div class="list-item">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table_data = $('#table-data').DataTable({
            ajax: {
                url : '<?php echo base_url();?>admin/content/faq/datatables',
            },
            columnDefs : [
                {
        ...
        $.validator.addMethod('cek_value', function(value, element) {
            $.ajax({
                url      : '<?php echo base_url();?>admin/content/faq/cek_value',
                data     : { value:value },
        ...
        var validate_form = $('#form-data').validate({
            ...
            messages: {
                heading: {
                    ...
                    cek_value: 'Question sudah digunakan'
                },
                description: {
        ...
        // --------------------------- add & edit data --------------------------- 
            ...
            $(document).on('click', '.edit-data', function() {
                ...
                $.ajax({
                    type     : 'POST',
                    url      : '<?php echo base_url(); ?>admin/content/faq/get_data',
                    data     : { id:id },
                    dataType : 'json',
                    success: function(response) {
                        $('#id').val(response.id);
            ...
            $('#form-data').submit(function(e) {
                ...
                if (validate_form.valid()) {
                    ...
                    if(save_method == 'add') {
                        url = '<?php echo base_url(); ?>admin/content/faq/add_data';
                    } else {
                        url = '<?php echo base_url(); ?>admin/content/faq/edit_data';
                    }
        ...
        // --------------------------- detail data ---------------------------
            $(document).on('click', '.detail-data', function() {
                ...
                $.ajax({
                    url      : '<?php echo base_url(); ?>admin/content/faq/detail_data',
                    data     : { id:id },
                    success: function(response) {
                        $('#d_heading').html(response.heading);
                        $('#d_description').html(response.description);
        ...
        // --------------------------- change status ---------------------------
            ...
            $(document).on('click', '#submit-change-status', function() {
                ...
                $.ajax({
                    type : 'POST',
                    url  : '<?php echo base_url();?>admin/content/faq/change_status',
        ...
        // --------------------------- delete data ---------------------------
            ...
            $(document).on('click', '#button-delete', function() {
                ...
                $.ajax({
                    type : 'POST',
                    url  : '<?php echo base_url();?>admin/content/faq/delete_data',
