...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table_data = $('#table-data').DataTable({
            ajax: {
                method   : 'post',
                url      : '<?php echo base_url();?>admin/content/gallery/datatables',
                dataType : 'json',
            ...
            language: {
                ...
                lengthMenu: '<select class="form-control form-control-sm select2">'+
        ...
        $.validator.addMethod('cek_value', function(value, element) {
            $.ajax({
                method   : 'post',
                url      : '<?php echo base_url();?>admin/content/gallery/cek_value',
                data     : { value:value },
                dataType : 'json',
        ...
        // --------------------------- add & edit data --------------------------- 
            ...
            $(document).on('click', '.edit-data', function() {
                ...
                $.ajax({
                    type     : 'POST',
                    url      : '<?php echo base_url(); ?>admin/content/gallery/get_data',
                    data     : { id:id },
                    dataType : 'json',
                    success: function(response) {
                        $('#id').val(response.id);
            ...
            $('#form-data').submit(function(e) {
                ...
                if (validate_form.valid()) {
                    ...
                    if(save_method == 'add') {
                        url = '<?php echo base_url(); ?>admin/content/gallery/add_data';
                    } else {
                        url = '<?php echo base_url(); ?>admin/content/gallery/edit_data';
                    }
        ...
        // --------------------------- detail data ---------------------------
            $(document).on('click', '.detail-data', function() {
                ...
                $.ajax({
                    type     : 'POST',
                    url      : '<?php echo base_url(); ?>admin/content/gallery/detail_data',
                    data     : { id:id },
                    dataType : 'json',
                    success: function(response) {
        ...
        // --------------------------- change status ---------------------------
            ...
            $(document).on('click', '#submit-change-status', function() {
                ...
                $.ajax({
                    type : 'POST',
                    url  : '<?php echo base_url();?>admin/content/gallery/change_status',
        ...
        // --------------------------- delete data ---------------------------
            ...
            $(document).on('click', '#button-delete', function() {
                ...
                $.ajax({
                    type : 'POST',
                    url  : '<?php echo base_url();?>admin/content/gallery/delete_data',
