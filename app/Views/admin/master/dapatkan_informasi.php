                    ...
                    <table id="table-data" class="table align-middle mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-center">Dapatkan Informasi</th>
            ...
            <div class="modal-body">
                <form method="post" id="form-data" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="control-label">Dapatkan Informasi<span class="text-danger">*</span></label>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table_data = $('#table-data').DataTable({
            ajax: {
                url : '<?php echo base_url();?>admin/master/dapatkan_informasi/datatables',
            },
            columnDefs : [
                {
        ...
        $.validator.addMethod('cek_value', function(value, element) {
            $.ajax({
                method   : 'post',
                url      : '<?php echo base_url();?>admin/master/dapatkan_informasi/cek_value',
                data     : { value:value },
                dataType : 'json',
        ...
        var validate_form = $('#form-data').validate({
            ...
            messages: {
                nama: {
                    required: 'Dapatkan Informasi harus diisi.',
                    // cek_value: 'Dapatkan Informasi sudah digunakan'
                },
                urutan: {
        ...
        // --------------------------- add & edit data --------------------------- 
            ...
            $(document).on('click', '.edit-data', function() {
                ...
                $.ajax({
                    type     : 'POST',
                    url      : '<?php echo base_url(); ?>admin/master/dapatkan_informasi/get_data',
                    data     : { id:id },
                    dataType : 'json',
                    success: function(response) {
                        $('#id').val(response.id_informasi);
            ...
            $('#form-data').submit(function(e) {
                ...
                if (validate_form.valid()) {
                    ...
                    if(save_method == 'add') {
                        url = '<?php echo base_url(); ?>admin/master/dapatkan_informasi/add_data';
                    } else {
                        url = '<?php echo base_url(); ?>admin/master/dapatkan_informasi/edit_data';
                    }
        ...
        // --------------------------- delete data ---------------------------
            ...
            $(document).on('click', '#button-delete', function() {
                ...
                $.ajax({
                    type : 'POST',
                    url  : '<?php echo base_url();?>admin/master/dapatkan_informasi/delete_data',
